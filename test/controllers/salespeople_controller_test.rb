...
class SalespeopleControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salesperson" do
    assert_difference('Salesperson.count') do
      post salespeople_url, params: { salesperson: { commission: @salesperson.commission, email: @salesperson.email, job_title: @salesperson.job_title, name: @salesperson.name, phone_no: @salesperson.phone_no, total_sales: @salesperson.total_sales } }
    end
  ...
  test "should update salesperson" do
    patch salesperson_url(@salesperson), params: { salesperson: { commission: @salesperson.commission, email: @salesperson.email, job_title: @salesperson.job_title, name: @salesperson.name, phone_no: @salesperson.phone_no, total_sales: @salesperson.total_sales } }
