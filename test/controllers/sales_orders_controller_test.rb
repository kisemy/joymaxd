...
class SalesOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sales_order" do
    assert_difference('SalesOrder.count') do
      post sales_orders_url, params: { sales_order: { address: @sales_order.address, city: @sales_order.city, contact_name: @sales_order.contact_name, contactno: @sales_order.contactno, customer_name: @sales_order.customer_name, customer_no: @sales_order.customer_no, order_date: @sales_order.order_date, order_no: @sales_order.order_no, sales_person_code: @sales_order.sales_person_code, sales_person_name: @sales_order.sales_person_name } }
    end
  ...
  test "should update sales_order" do
    patch sales_order_url(@sales_order), params: { sales_order: { address: @sales_order.address, city: @sales_order.city, contact_name: @sales_order.contact_name, contactno: @sales_order.contactno, customer_name: @sales_order.customer_name, customer_no: @sales_order.customer_no, order_date: @sales_order.order_date, order_no: @sales_order.order_no, sales_person_code: @sales_order.sales_person_code, sales_person_name: @sales_order.sales_person_name } }
