class VillagesController < ApplicationController
  ...
  private
    ...
    def village_params
      params.require(:village).permit(:village_code, :village_name, :sub_county_code, :sub_county_name, :ward_code, :ward_name, :village_admin_pno, :village_admin_name, :village_admin_telephone, :village_admin_email)
    end
end
