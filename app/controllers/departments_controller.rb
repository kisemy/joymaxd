class DepartmentsController < ApplicationController
  ...
  private
    ...
    def department_params
      params.require(:department).permit(:department_code, :department_name, :current_CEC_p_no, :current_CEC_name, :current_CEC_telephone, :current_CEC_email, :general_dept_email)
    end
end
